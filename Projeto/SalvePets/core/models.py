...
class INSTITUICAO(models.Model):
    ...
    doacao_limpeza_link = models.CharField(_("URL para ajudar com limpeza"), max_length=250, null = True, blank = True)
    doacao_limpeza_valor = models.DecimalField(_("Valor da limpeza"), max_digits=6, decimal_places=2, null = True, blank = True)

    doacao_alimentacao_link = models.CharField(_("URL para ajudar com alimentação"), max_length=250, null = True, blank = True)
    doacao_alimentacao_valor = models.DecimalField(_("Valor da alimentação"), max_digits=6, decimal_places=2, null = True, blank = True)

    doacao_medicamentos_link = models.CharField(_("URL para ajudar com medicamentos"), max_length=250, null = True, blank = True)
    ...
    doacao_diaria_internacao_link = models.CharField(_("URL para ajudar com diária de internação"), max_length=250, null = True, blank = True)
